...
To compare the abundance of OTUs in the suspensions, we applied a loglikelihood ratio test to the OTUs that had an abundance in a manipulated suspension representing less than 40% or more than 60% of the total abundance in both the manipulated and non-manipulated control suspensions (see code available online).

```{r OTUs_in_suspensions}
