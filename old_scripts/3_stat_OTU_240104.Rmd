...
write.table(tmp_data,"tmp_itol_tree_taxo.txt",quote = F,sep = ",",row.names = F)
...
write.table(tmp_itol,"itol/tmp_itol_connection.txt",quote = F,sep = ",",row.names = F)
